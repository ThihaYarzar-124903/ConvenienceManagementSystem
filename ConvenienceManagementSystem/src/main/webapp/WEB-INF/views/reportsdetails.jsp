...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
            <form class="bg-white mt-5 p-4 rounded shadow" action="/ConvenienceManagementSystem/detail" method="POST">
            	<h2>Report Form</h2>
                <div class="form-group">
                    <label for="accountId">Account ID</label>
                    <input type="text" id="accountId" class="form-control" name="accountId" required="required" placeholder="Enter staff id">
                </div>
                
                <div class="form-group">
        			<label for="fromDate">From Date</label>
        			<input type="text" id="fromDate" class="form-control" name="fromDate" required="required" placeholder="Enter from date">
    			</div>
    
    			<div class="form-group">
        			<label for="toDate">To Date</label>
        			<input type="text" id="toDate" class="form-control" name="toDate" required="required" placeholder="Enter to date">
    			</div>

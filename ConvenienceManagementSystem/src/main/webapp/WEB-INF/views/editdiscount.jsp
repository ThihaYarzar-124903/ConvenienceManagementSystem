    ...
    <div class="second d-flex flex-column align-items-center p-4" >	
     ...
     <h2>Update Discount Form</h2>
		...
		<div>
			...
			<form:input path="to_date" type="date" class="form-control" style="margin-bottom:10px;" min="<%= new java.util.Date().toInstant().atZone(java.time.ZoneId.systemDefault()).toLocalDate() %>"/>
